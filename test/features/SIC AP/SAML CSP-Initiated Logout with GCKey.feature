...
@auth @saved @GCKey @logout @saml @sso
Feature: CATSLAB - SAML CSP-Initiated Logout using GCKey
    ...
    Scenario: SAML CSP-Initiated Logout using GCKey
        ...
        Then I should see "SP initiated single logout succeeded"