...
const locators = {
  "RP1": "https://rp1.tbstest.catslab.ca/RPSimulator/home-eng.jsp?_gc_lang=eng",
  "PowerApps": "https://catslab.powerappsportals.com/",
  "RP simulator English chooser":
    "https://rp1.tbstest.catslab.ca/RPSimulator/choose-eng.jsp",
  "QA chooser": "https://qa-auth.id.alpha.canada.ca/oxauth/en/select.htm",
  "Level 2":
    '//*[@id="cn-left-col-inner"]/section/div/nav/form/section[1]/ul/li[2]/input',
  "Force Authn":
    '//*[@id="cn-left-col-inner"]/section/div/nav/form/section[2]/ul/li[1]/input',
  "GCKeyCSP": process.env.CSP_HOST || "Sign In Canada - QA",
  "Sign up with GCKey": '//*[@id="loginForm:loginButton3"]',
  "Sign Up": {
    xpath:
      "/html/body/div[1]/main/div[2]/div/div/div/div/div/div[3]/div/p[3]/a",
  },
  "I accept": '//*[@id="Accept"]',
